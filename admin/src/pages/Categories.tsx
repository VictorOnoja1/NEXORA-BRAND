...
export default function AdminCategories() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (editingId) {
      updateCategory(editingId, { name: form.name, descriptor: form.descriptor, image: form.image });
    } else {
      addCategory({ name: form.name, descriptor: form.descriptor, image: form.image, slug: "" as CategorySlug });
    }
    setModalOpen(false);
  }
