...
export default function AdminProductForm() {
  ...
  return (
    <div className="max-w-3xl">
      <Link to="/admin/products" className="inline-flex items-center gap-1 text-sm text-black hover:text-black mb-4">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        <div className="border border-plum-100 rounded-lg p-5">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              />
              {imageBroken && (
                <p className="text-[11px] text-red-500 mt-1.5 font-sans">
                  This image link doesn't load — double-check the URL, or use a placeholder above. The product can still be saved, but the storefront will show a blank image icon until this is fixed.
                </p>
              )}
            </div>
          </div>
        ...
        <div className="border border-plum-100 rounded-lg p-5 flex flex-col gap-3">
          ...
          <label className="flex items-center gap-2.5 text-sm text-chocolate">
            <input type="checkbox" className="accent-plum w-4 h-4" checked={form.active} onChange={(e) => update("active", e.target.checked)} />
