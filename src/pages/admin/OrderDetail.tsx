...
export default function AdminOrderDetail() {
  ...
  return (
    <div className="max-w-3xl">
      <Link to="/admin/orders" className="inline-flex items-center gap-1 text-sm text-black hover:text-black mb-4">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="border border-plum-200 rounded px-3 py-2 text-sm text-chocolate capitalize focus:outline-none focus:border-plum disabled:opacity-50"
          >
