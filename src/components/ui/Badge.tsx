...
const variants: Record<string, string> = {
  ...
  outline: "border border-plum-200 text-black bg-ivory",
...
export function Badge({ children, variant = "plum", className }: BadgeProps) {
  return (
    <span
      className={clsx(
        "inline-flex items-center whitespace-nowrap text-[10px] font-semibold uppercase tracking-widest2 px-2.5 py-1 rounded-sm",
        variants[variant],
        className
      )}
    >
