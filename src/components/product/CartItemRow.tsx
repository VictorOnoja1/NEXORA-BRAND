      ...
      <div className="flex-1 min-w-0 flex flex-col justify-between">
        <div>
          <Link to={`/product/${product.slug}`}>
            <h3 className="text-sm md:text-base text-chocolate font-medium line-clamp-2 mb-1 hover:text-black">
              {product.name}
            </h3>
          </Link>
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          <button
            ...
            className="text-black hover:text-black transition-colors p-1.5"
          >
            <Trash2 size={17} />
          </button>
        </div>
