      ...
      <div className="max-w-8xl mx-auto px-6 md:px-10 pt-14 pb-8">
        ...
        <div className="border-t border-ivory/10 mt-12 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <NewsletterForm
            ...
            inputClassName="flex-1 bg-ivory/5 border border-ivory/15 rounded px-3.5 py-2.5 text-sm text-ivory placeholder:text-ivory/40 focus:outline-none focus:border-champagne"
          />
