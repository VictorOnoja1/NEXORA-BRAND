      ...
      <div className="hidden md:flex items-center justify-between max-w-8xl mx-auto px-8 h-20">
        ...
        <div className="flex items-center gap-5">
          <button
            ...
            className="text-chocolate hover:text-black hover:-translate-y-0.5 transition-all"
          >
            <Search size={20} />
          </button>
          <Link
            to="/wishlist"
            aria-label="Wishlist"
            className="relative text-chocolate hover:text-black hover:-translate-y-0.5 transition-all"
          >
            <Heart size={20} />
            <CountBadge
              count={wishlistCount}
