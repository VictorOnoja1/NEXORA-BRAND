                ...
                <div className="flex flex-wrap gap-2">
                  {categories.map((c, i) => (
                    <motion.button
                      ...
                      className="px-4 py-2 rounded-full border border-plum-200 text-sm text-chocolate hover:bg-plum hover:text-ivory hover:border-plum active:scale-95 transition-all"
                    >
                      {c.name}
                    </motion.button>
                  ))}
